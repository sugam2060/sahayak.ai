...
logger = logging.getLogger("shared.presence.service")
...
async def get_eligible_online_users(org_id: str, db: "AsyncSession", presence_service: "PresenceService", exclude_user_id: str) -> list[Any]:
